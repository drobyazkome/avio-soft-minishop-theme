...
Замок живёт на главной, в «Устройствах» без подписки и на экране входа.
...
- Промокод — тихое поле, «Применить» появляется при вводе. Баланс партнёрки включается переключателем.
...
- `images/lock-sleep.svg`, `lock-happy.svg`, `lock-worry.svg` — персонаж, авторский SVG.
...
Версия 2.0.0 проверена на demo-сборке Core dev в Chromium:

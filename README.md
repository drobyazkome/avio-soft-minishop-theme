...
**Покупка.**
- Выбранный тариф — строка-заголовок шторки: название, кнопка «Настройка тарифа» (если лимиты можно
  менять) и крестик в одной строке, под ними лимиты плашками («📱 3 · ⇅ Безлимит · 15 GB»).
  Без отдельной коробки нечему съезжать относительно сроков.
...
Версия 2.2.0 проверена на demo-сборке Core dev в Chromium:
...
Проверены оба режима на ширине 320, 390 и 1440 px и в окне 425 × 520, панель сверху проверена на 1024 px.
